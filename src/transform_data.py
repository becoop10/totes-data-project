...
def lambda_handler(event, context):
    ...
    ingestedTableNames = ["sales_order", "counterparty", "currency", "department", "design",
                          "staff", "address", "payment_type", "payment", "purchase_order", "transaction"]
            ...
            if datakey in processTableNames[tablekey]:
                ...
                if tablekey == "dim_counterparty" or tablekey == "dim_staff":
                    formatteddata = functionList[2](
                        dataToBeFormatted[functionList[0]], dataToBeFormatted[functionList[1]])
                else:
