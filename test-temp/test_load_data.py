from src.load_data import (read_csv, read_parquet, write_to_db, query_builder, data_sorter)
import pytest
import pandas as pd
...
def test_read_csv_reads_from_csv_at_path():
    ...
    conn.put_object(Bucket=BUCKETNAME, Key='test_csv', Body=out_buffer.getvalue())
